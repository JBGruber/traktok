...
To learn about both access pathways, you should check out the [Research API](https://jbgruber.github.io/traktok/articles/research-api.html) and [Unofficial API](https://jbgruber.github.io/traktok/articles/unofficial-api.htmlc) vignettes.
